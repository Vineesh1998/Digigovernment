    ...
    <header>
      ...
      <div class="container">
        ...
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
              <a href="index.php"><img src="pancha_theme.png" alt="" /></a>
            </div>
          </div>
          <div class="span8">
                ...
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="">Public Functions</a></li>
                        <li><a href="">Complaints</a></li>
                        <!-- <li><a href="death.php">Death Reports</a></li> -->
            ...
            <aside class="left-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="cat">
                  ...
                  <li><i class="icon-angle-right"></i> <a href="death.php">Death Reports</a><span></span></li>
